...
const LOGOS_DARK = ['corporacion-3xi','clickie','e-contact','echeverria-izquierdo','isamax','timix-chile','kiosclub'];
...
<head>
  ...
  <script>
    firebase.initializeApp({
      apiKey: "AIzaSyBJBYEIWUjjHYyE5eTZSpFzh4-4HtP4R5I",
...
<footer>
  <p>ElInterno.com — Reseñas anónimas de empresas chilenas &nbsp;·&nbsp; <a href="/directorio/">Directorio</a> &nbsp;·&nbsp; <a href="/legal.html">Aviso legal</a> &nbsp;·&nbsp; <a href="mailto:hola@elinterno.com">hola@elinterno.com</a></p>
</footer>
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .cta-compartir { margin-top: 2.5rem; border: 1.5px solid var(--border); border-radius: 12px; background: var(--bg); }
    .cta-compartir-inner { display: flex; align-items: center; justify-content: space-between; gap: 1.5rem; padding: 1.25rem 1.5rem; flex-wrap: wrap; }
    .cta-compartir-texto { display: flex; flex-direction: column; gap: 4px; }
    .cta-compartir-texto strong { font-size: 0.95rem; color: var(--text); }
    .cta-compartir-texto span { font-size: 0.85rem; color: var(--text-muted); }
    .cta-compartir-botones { display: flex; gap: 8px; flex-shrink: 0; }
    .btn-compartir { padding: 8px 16px; border-radius: 8px; font-size: 0.85rem; font-weight: 600; cursor: pointer; border: none; text-decoration: none; display: inline-flex; align-items: center; transition: opacity 0.15s; }
    .btn-compartir:hover { opacity: 0.85; }
    .btn-whatsapp { background: #25d366; color: #fff; }
    .btn-copiar { background: var(--navy); color: #fff; }
    @media (max-width: 600px) { .cta-compartir-inner { flex-direction: column; align-items: flex-start; } }
